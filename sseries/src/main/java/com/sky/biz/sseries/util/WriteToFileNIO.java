...
public class WriteToFileNIO {
	...
	private static final String TARGETOBJECT = "titleName";
	private static final String WEBTARGETOBJECT = "title_name";
...
//			+ "\\business-partner-group-list.xhtml";
	...
	public static void main(String[] args) throws IOException {
		...
		String webCenter = "<ui:composition xmlns=\"http://www.w3.org/1999/xhtml\"\n xmlns:ui=\"http://java.sun.com/jsf/facelets\"\n xmlns:h=\"http://java.sun.com/jsf/html\"\n xmlns:f=\"http://java.sun.com/jsf/core\"\n xmlns:p=\"http://primefaces.org/ui\">\n\t<h:form>\n\t\t<input type=\"hidden\" name=\"${_csrf.parameterName}\" value=\"${_csrf.token}\"/>\n\t\t<p:ribbon>\n\t\t\t<p:tab title=\" Title Name\">\n\t\t\t\t<p:ribbonGroup label=\"New\">\n\t\t\t\t\t<p:commandButton value=\"New\" icon=\"ui-ribbonicon-new\" update=\":centerContentPanel\" styleClass=\"ui-ribbon-bigbutton\" disabled=\"#{titleNameController.disabledNewEvent}\" actionListener=\"#{titleNameController.newAction}\" />\n\t\t\t\t\t<p:commandButton value=\"Save\" icon=\"ui-ribbonicon-save\"  update=\":centerContentPanel\"  styleClass=\"ui-ribbon-bigbutton\" disabled=\"#{titleNameController.disabledSaveEvent}\" actionListener=\"#{titleNameController.saveAction}\"/>\n\t\t\t\t</p:ribbonGroup>\n\t\t\t<p:ribbonGroup label = \"Find\">\n\t\t\t\t\t<p:commandButton value=\"Finding\" icon=\"ui-ribbonicon-find\" update=\":centerContentPanel\" styleClass=\"ui-ribbon-bigbutton\" disabled=\"#{titleNameController.disabledFindEvent}\" actionListener=\"#{titleNameController.findAction}\" />\n\t\t\t\t\t<p:commandButton value=\"View\" icon=\"ui-ribbonicon-find\" update=\":centerContentPanel\" styleClass=\"ui-ribbon-bigbutton\" disabled=\"#{titleNameController.disabledFindEvent}\" actionListener=\"#{titleNameController.viewAction}\" />\n\t\t\t\t</p:ribbonGroup>\n\t\t\t\t<p:ribbonGroup label=\"Editing\">\n\t\t\t\t\t<p:commandButton value=\"Modify\" icon=\"ui-ribbonicon-save\"  update=\":centerContentPanel\"  styleClass=\"ui-ribbon-bigbutton\" disabled=\"#{titleNameController.disabledEditEvent}\" actionListener=\"#{titleNameController.editAction}\"/> \n\t\t\t\t</p:ribbonGroup>\n\t\t\t\t<p:ribbonGroup label=\"Export\">\n\t\t\t\t</p:ribbonGroup>\n\t\t\t</p:tab>\n\t\t\t</p:ribbon>\n\t\t\t</h:form>\n\t\t\t<br/>\n\t\t\t<ui:include src=\"/#{titleNameController.currentSubView}.xhtml\" />\n</ui:composition>";
		String webCreate = "<ui:composition xmlns=\"http://www.w3.org/1999/xhtml\"\n xmlns:ui=\"http://java.sun.com/jsf/facelets\"\n xmlns:h=\"http://java.sun.com/jsf/html\"\n xmlns:f=\"http://java.sun.com/jsf/core\"\n xmlns:p=\"http://primefaces.org/ui\">\n\t<div class=\"ui-fluid\">\n\t<h:form id=\"TitleNameModifyForm\">\n\t\t<input type=\"hidden\" name=\"${_csrf.parameterName}\" value=\"${_csrf.token}\" />\n\t\t<p:panel header=\" Title Name\">\n\t\t\t<p:growl id=\"growl\" life=\"10000\" />\n\t\t\t<p:panelGrid columns=\"3\" columnClasses=\"ui-grid-col-3,ui-grid-col-10\" layout=\"grid\" styleClass=\"ui-panelgrid-blank\">\n\t\n\t\t\t\t<p:outputLabel value=\"Is Active: \" for=\"isActive\"/>\n\t\t\t\t<p:selectBooleanCheckbox id=\"isActive\" value=\"#{titleNameController.mainTitleNameDTO.isActive}\"/>\n\t\t\t\t<p:message for=\"isActive\"/>\n\t\t\t\t<p:outputLabel value=\"Name:\" for=\"name\"/>\n\t\t\t\t<p:inputText id=\"name\" value=\"#{titleNameController.mainTitleNameDTO.name}\"/>\n\t\t\t\t<p:message for=\"name\" />\n\t\t\t\t<p:outputLabel value=\"Abbrname:\" for=\"abbrname\"/>\n\t\t\t\t<p:inputText id=\"abbrname\" value=\"#{titleNameController.mainTitleNameDTO.abbrname}\"/>\n\t\t\t\t<p:message for=\"abbrname\" />\n\t\t\t\t<p:outputLabel value=\"Description:\" for=\"description\"/>\n\t\t\t\t<p:inputText id=\"description\" value=\"#{titleNameController.mainTitleNameDTO.description}\"/>\n\t\t\t\t<p:message for=\"description\" />\n\t\t\t</p:panelGrid>\n\t\t\t<div align=\"center\">\n\t\t\t\t<p:commandButton value=\"Save\" id=\"ajax\" update=\":centerContentPanel\" disabled=\"#{titleNameController.disabledSaveEvent}\" actionListener=\"#{titleNameController.saveAction}\" styleClass=\"ui-priority-primary\" style=\"width: 20%\" icon=\"ui-icon-disk\"/>\n\t\t\t\t<p:commandButton value=\"Save-Continue\" id=\"ajax2\" update=\"growl\" disabled=\"#{titleNameController.disabledSaveEvent}\" actionListener=\"#{titleNameController.saveAction2}\" styleClass=\"ui-priority-primary\" style=\"width: 20%\" icon=\"ui-icon-disk\"/>\n\t\t\t</div>\n\t\t</p:panel>\n\t</h:form>\n\t</div>\n</ui:composition>";
		String webEdit = "<ui:composition xmlns=\"http://www.w3.org/1999/xhtml\"\n xmlns:ui=\"http://java.sun.com/jsf/facelets\"\n xmlns:h=\"http://java.sun.com/jsf/html\"\n xmlns:f=\"http://java.sun.com/jsf/core\"\n xmlns:p=\"http://primefaces.org/ui\">\n\t<div class=\"ui-fluid\">\n\t<h:form id=\"TitleNameModifyForm\">\n\t\t<input type=\"hidden\" name=\"${_csrf.parameterName}\" value=\"${_csrf.token}\" />\n\t\t<p:panel header=\" Title Name\">\n\t\t\t<p:growl id=\"growl\" life=\"10000\" />\n\t\t\t<p:panelGrid columns=\"3\" columnClasses=\"ui-grid-col-3,ui-grid-col-10\" layout=\"grid\" styleClass=\"ui-panelgrid-blank\">\n\t\n\t\t\t\t<p:outputLabel value=\"Is Active: \" for=\"isActive\"/>\n\t\t\t\t<p:selectBooleanCheckbox id=\"isActive\" value=\"#{titleNameController.mainTitleNameDTO.isActive}\"/>\n\t\t\t\t<p:message for=\"isActive\"/>\n\t\t\t\t<p:outputLabel value=\"Name:\" for=\"name\"/>\n\t\t\t\t<p:inputText id=\"name\" value=\"#{titleNameController.mainTitleNameDTO.name}\"/>\n\t\t\t\t<p:message for=\"name\" />\n\t\t\t\t<p:outputLabel value=\"Abbrname:\" for=\"abbrname\"/>\n\t\t\t\t<p:inputText id=\"abbrname\" value=\"#{titleNameController.mainTitleNameDTO.abbrname}\"/>\n\t\t\t\t<p:message for=\"abbrname\" />\n\t\t\t\t<p:outputLabel value=\"Description:\" for=\"description\"/>\n\t\t\t\t<p:inputText id=\"description\" value=\"#{titleNameController.mainTitleNameDTO.description}\"/>\n\t\t\t\t<p:message for=\"description\" />\n\t\t\t</p:panelGrid>\n\t\t\t<div align=\"center\">\n\t\t\t\t<p:commandButton value=\"Update\" id=\"updateCommandButton\" update=\":centerContentPanel\" disabled=\"#{titleNameController.disabledSaveEvent}\" actionListener=\"#{titleNameController.updateAction}\" styleClass=\"ui-priority-primary\" style=\"width: 20%\" icon=\"ui-icon-disk\"/>\n\t\t\t</div>\n\t\t</p:panel>\n\t</h:form>\n\t</div>\n</ui:composition>";
		...
		String webView = "<ui:composition xmlns=\"http://www.w3.org/1999/xhtml\"\n xmlns:ui=\"http://java.sun.com/jsf/facelets\"\n xmlns:h=\"http://java.sun.com/jsf/html\"\n xmlns:f=\"http://java.sun.com/jsf/core\"\n xmlns:p=\"http://primefaces.org/ui\">\n\t<div class=\"ui-fluid\">\n\t<h:form id=\"TitleNameViewForm\">\n\t\t<input type=\"hidden\" name=\"${_csrf.parameterName}\" value=\"${_csrf.token}\" />\n\t\t<p:panel header=\" Title Name\">\n\t\t\t<p:growl id=\"growl\" life=\"10000\" />\n\t\t\t<p:panelGrid columns=\"2\" columnClasses=\"ui-grid-col-3,ui-grid-col-10\" layout=\"grid\" styleClass=\"ui-panelgrid-blank\">\n\t\n\t\t\t\t<p:outputLabel value=\"Is Active: \" />\n\t\t\t\t<p:selectBooleanCheckbox value=\"#{titleNameController.selectedTitleNameDTO.isActive}\" disabled=\"true\"/>\n\t\t\t\t<p:outputLabel value=\"Name:\"/>\n\t\t\t\t<p:outputLabel value=\"#{titleNameController.selectedTitleNameDTO.name}\"/>\n\t\t\t\t<p:outputLabel value=\"Abbrname:\"/>\n\t\t\t\t<p:outputLabel value=\"#{titleNameController.selectedTitleNameDTO.abbrname}\"/>\n\t\t\t\t<p:outputLabel value=\"Description:\"/>\n\t\t\t\t<p:outputLabel value=\"#{titleNameController.selectedTitleNameDTO.description}\"/>\n\t\t\t</p:panelGrid>\n\t\t</p:panel>\n\t</h:form>\n\t</div>\n</ui:composition>";
