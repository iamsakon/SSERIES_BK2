...
import com.sky.biz.sseries.usm.dto.PrivilegeDTO;
import com.sky.biz.sseries.usm.services.impl.PrivilegeServiceImpl;
@Component("privilegeConverter")
public class PrivilegeConverter implements Converter {
	...
	public Object getAsObject(FacesContext fc, UIComponent uic, String value) {
		if(value != null && value.trim().length() > 0) {
			try {
				return privilegeServiceImpl.loadById(Long.parseLong(value));
	...
	public String getAsString(FacesContext fc, UIComponent uic, Object object ) {
		if(object != null && object.toString().trim().length() > 0) {
			String val = String.valueOf(((PrivilegeDTO) object).getId());
			return val;
		}
		else {return null;}
	}
